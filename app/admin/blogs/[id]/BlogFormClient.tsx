    ...
    <div className="max-w-5xl mx-auto space-y-6 pb-12">
      <div className="flex items-center justify-between">
        ...
        >
          ...
          {formData.status === 'published' ? 'Publish Blog' : formData.status === 'scheduled' ? 'Schedule Blog' : 'Save Draft'}
        </button>
      </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Top 5 EdTech Trends Shaping K-12 Learning in 2026"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    value={formData.slug}
                    onChange={handleChange}
                    placeholder="top-5-edtech-trends-2026"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="A concise summary of the blog post for preview cards..."
                  className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition ${
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 space-y-4">
              <div className="border-b pb-3">
                ...
                <p className="text-xs text-gray-500 mt-0.5">Configure meta tags and social card attributes for this blog post.</p>
              </div>
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-400 mt-1">Falls back to Blog Title if empty.</p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="e.g. EdTech blog, digital classroom, LMS, NEP 2020"
                  className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
                />
              </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 space-y-4">
                ...
                <div className="p-3.5 bg-blue-50/60 border border-blue-200 rounded-lg space-y-2">
                  ...
                  {errors.scheduledDate ? (
                    ...
                    <p className="text-xs text-blue-700">
                      The blog post will automatically become visible on the website at this exact date & time.
                    </p>
                  )}
                </div>
              )}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="e.g. Navneet Toptech Editorial Team"
