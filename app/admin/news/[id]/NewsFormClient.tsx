...
export default function NewsFormClient() {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const q = query(collection(db, 'newsCategories'), orderBy('name', 'asc'));
  ...
  const validate = (): boolean => {
    ...
    if (!formData.author.trim()) {
      newErrors.author = 'Author / Publication is required.';
    }
    ...
    <div className="max-w-5xl mx-auto space-y-6 pb-12">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Link href="/admin/news" className="p-2 hover:bg-gray-100 rounded-full text-gray-500 transition">
        ...
        >
          ...
          {formData.status === 'published' ? 'Publish News' : formData.status === 'scheduled' ? 'Schedule News' : 'Save Draft'}
        </button>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Navneet Toptech Wins Top EdTech Award 2026"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    value={formData.slug}
                    onChange={handleChange}
                    placeholder="navneet-toptech-wins-award"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder="A brief 1-2 sentence overview of the news announcement..."
                  className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none transition ${
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 space-y-4">
              <div className="border-b pb-3">
                ...
                <p className="text-xs text-gray-500 mt-0.5">Customize how this news article appears on search engines and social feeds.</p>
              </div>
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-400 mt-1">Falls back to News Title if empty.</p>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="e.g. EdTech, Navneet Toptech, School LMS, Awards"
                  className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
                />
              </div>
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Author / Publication <span className="text-red-500">*</span>
                </label>
                <input
                  type="text"
                  name="author"
                  ...
                  onChange={handleChange}
                  placeholder="e.g. Economic Times, Education World"
