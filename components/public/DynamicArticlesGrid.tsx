  ...
  return (
    <section className="sec sec-white">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          <p className="tag green-text">Latest Articles</p>
          <h2 className="heading blue-text">Insights & Articles.</h2>
        </div>
        {categories.length > 1 && (
      ...
      {loading ? (
        <div className="admin-empty">Loading articles…</div>
      ) : !filtered.length ? (
        <div className="admin-empty">No articles published yet.</div>
      ) : (
